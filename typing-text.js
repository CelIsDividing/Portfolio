...
const text = `$ nc cellsdividing.net 1337
                ...
                1. ls ./projects
                2. cat ./skills.txt
                3. ssh collab@cellsdividing.net
                4. exit (not recommended)
...
const linkLines = {
    "1. ls ./projects": "projects.html",
    "2. cat ./skills.txt": "skills.html",
    "3. ssh collab@cellsdividing.net": "contact.html",
    "4. exit (not recommended)": "index.html"
};
